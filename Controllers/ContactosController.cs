...
namespace Videogames_Store.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CódigoArea,NúmeroTeléfono,Email")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CódigoArea,NúmeroTeléfono,Email")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
